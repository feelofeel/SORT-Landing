...
- **Package version:** 1.1.0 (cut 2026-09-20). `CHANGELOG.md` `[Unreleased]` logs deployments as they ship and is cut into a dated `[x.y.z]` section only when Dee decides a batch is coherent (`sort-release` §5); there is no automatic release train.
