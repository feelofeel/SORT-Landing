...
4. «Чи не засипатиме SORT сповіщеннями?» — Ні: бариста — лише пуш на початку й наприкінці зміни; менеджеру не частіше ніж раз на тиждень (частіше — лише коли партію зняли з полиці); непсувні позиції не стають рішеннями за кількістю; дрібні розбіжності з Poster відсікає «Допустима різниця» (app 1.86.0).
