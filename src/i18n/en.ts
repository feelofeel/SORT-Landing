	...
	features: {
		...
		items: [
			...
			},
			{
				...
				img: "/screenshots/f3-writeoff.jpg",
			},
			{
				ico: "✓",
				...
				shot: "F4 · «New batches»",
				img: "/screenshots/f4-new-batch.jpg",
			},
			{
				ico: "📊",
				...
				img: "/screenshots/f5-analytics.jpg",
			},
			{
				ico: "🥛",
				...
				img: "/screenshots/f6-visualization.jpg",
			},
		],
		chips: [
			"📶 Works offline",
