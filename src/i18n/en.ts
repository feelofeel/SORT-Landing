...
export const en: Content = {
	...
	hero: {
		...
		frame: {
			url: "sort · Today",
			title: "A tour of the «Today» screen",
			desc: "A short video about the daily SORT workflow will appear here soon.",
	...
	features: {
		...
		items: [
			...
			},
			{
				...
				img: "/Screenshots/F6-shelf-card.png",
